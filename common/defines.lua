...
NDiplomacy = {
	...
	HRE_PRINCE_AUTHORITY_THRESHOLD = 75,  -- Threshold below which you lose IA and above which you gain it
...
NCountry = {
	...
	MAX_CROWN_COLONIES = 2000,  -- How many province a country can hold in a colonial region before creating a colonial nation
...
NEconomy = {
	...
	EDICTS_DURATION_MONTHS = 36,				-- months lastin at least.
	...
	MIN_ARMY_MAINTENANCE = 0.333,
	MIN_NAVY_MAINTENANCE = 0.333,
...
NMilitary = {
	...
	SLACKEN_MAX_MP_PERCENTAGE = 0.95,  
...
NAI = {
	...
	PEACE_CALL_FOR_PEACE_FACTOR = 5,	-- How much AI wants peace based on having call for peace
	...
	PEACE_TERMS_CHANGE_RELIGION_BASE_MULT = 500.0, -- only applied if CB is valid for it
...
NReligion = {
	...
	INVEST_PAPAL_INFLUENCE = 1000.0,  -- The amount of papal influence you invest in becoming controller of the curia.
...
NGovernment = {
	...
	GOVERNMENT_REFORM_BASE_COST = 0.0,		--Make it free, requirements are everything in M&T
	GOVERNMENT_REFORM_COST_INCREASE = 40.0,
	GOVERNMENT_REFORM_YEARLY_BASE_PROGRESS = 10.0,
	GOVERNMENT_REFORM_HISTORIC_AUTONOMY = 0.25,
	GOVERNMENT_REFORM_CHANGE_PROGRESS_COST = 0.0,		--Make it free, requirements are everything in M&T
